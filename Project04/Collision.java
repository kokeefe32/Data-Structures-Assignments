...
public class Collision implements Comparable <Collision>{
	...
	static private SortOrder sortOrder = SortOrder.ZIP; 
	...
	/**
	 * Creates a Collision object given a LinkedList of entries. (edited by Kayli O'Keefe)
	 ...
	 * 
	 */
	public Collision ( LinkedList<String> entries ) throws IllegalArgumentException {
